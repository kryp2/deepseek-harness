...
describe('Metered Inference Receipt Conformance (Golden Vectors)', () => {
  it('matches canonical serialization and SHA-256 for all golden vectors', () => {
    for (const vector of vectorsJson.vectors) {
      const receipt = vector.receipt as MeteredInferenceReceipt
  ...
  it('validates signed receipts and rejects malformed fields', () => {
    const validReceipt: SignedMeteredReceipt = {
      version: 'peck/v1/inference-receipt',
      requestId: 'req_12345',
      channelOutpoint: '43dd688a0e88942b0f49f4857493a743b3b44b8296a23a492161dc225c28ad95:0',
      channelSequence: 5,
      routeId: 'peck/deepseek-v4-flash',
      upstreamModelId: 'deepseek-v4-flash',
      catalogHash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
      ...
      responseHash: 'ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad',
...
describe('meteredReceipts Projection', () => {
  ...
  it('aggregates metered receipts and charges in session projection', async () => {
    ...
    const receipt1: SignedMeteredReceipt = {
      version: 'peck/v1/inference-receipt',
      requestId: 'req_1',
      channelOutpoint: '43dd688a0e88942b0f49f4857493a743b3b44b8296a23a492161dc225c28ad95:0',
      channelSequence: 1,
      ...
      responseHash: 'ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad',
      timestampMs: 1787044000000,
      gatewaySignature: 'sig1',
    }

    session.append('peck/metered-receipt', receipt1)
